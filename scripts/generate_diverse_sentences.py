...
# 上のSHAPESは全て「役所の会議・点検の報告調・第三者視点・過去形」という
# 一つの登場人物・一つの話法しか持たない (骨格を増やしても文体が単調という
# 指摘への対応)。話法・人称・時制・発話行為 (報告/質問/指示/注意/独白/連絡)
# を変えた別の文体群を追加し、SHAPES全体に占める「役所報告調」の比率を
# 相対的に下げる。これらは基本的に ctx/subj を使わず (=term-leading で
# 無制限)、tail も使わない自己完結文にして、文法崩壊のリスクを避ける。
QUESTION_SHAPES = [
    "{term}について、詳しく教えてもらえますか。",
    "{term}は、どこで確認できますか。",
    "この{term}という言葉を、聞いたことがありますか。",
    "{term}に関して、何か質問はありますか。",
    "{term}の件、今どうなっていますか。",
    "{subj}さん、{term}の状況を教えてください。",
]

INSTRUCTION_SHAPES = [
    "{term}については、必ず記録を残してください。",
    "{term}の状態を、毎回確認しておくこと。",
    "{term}に変化があれば、すぐに連絡してください。",
    "{term}を確認したうえで、次の工程に進んでください。",
    "{term}の取り扱いには、十分注意すること。",
    "{term}に関する対応を、後回しにしないでください。",
]

CASUAL_SHAPES = [
    "最近、{term}という言葉をよく耳にする。",
    "正直なところ、{term}のことはまだよく分からない。",
    "{term}について調べてみたら、思ったより奥が深かった。",
    "先輩から{term}の話を聞いて、少し驚いた。",
    "{term}という用語は、この分野でよく使われている。",
    "恥ずかしながら、{term}の意味を今日初めて知った。",
]

REFERENCE_SHAPES = [
    "{term}は、この分野で使われる専門用語の一つだ。",
    "資料には「{term}」という語が繰り返し登場する。",
    "{term}という表記を、今回初めて目にした。",
    "用語集には、{term}の項目が記載されている。",
    "{term}という言葉の意味を、辞典で調べた。",
    "「{term}」の読み方について、社内で確認が取れた。",
]

COMMUNICATION_SHAPES = [
    "{term}の件で、折り返しご連絡いたします。",
    "{term}について、メールでご確認いただけますでしょうか。",
    "先日お伝えした{term}の件、その後いかがでしょうか。",
    "{term}に関するご連絡、確かに承りました。",
]

NARRATIVE_SHAPES = [
    "{term}をめぐる動きが、このところ活発になっている。",
    "{term}に関する取り組みが、各地で進められている。",
    "{term}の状況は、地域によって大きく異なる。",
    "{term}という課題は、以前から指摘されてきた。",
]

SHAPES += QUESTION_SHAPES + INSTRUCTION_SHAPES + CASUAL_SHAPES + REFERENCE_SHAPES + COMMUNICATION_SHAPES + NARRATIVE_SHAPES
